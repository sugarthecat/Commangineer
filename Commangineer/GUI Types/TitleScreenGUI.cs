...
namespace Commangineer.GUI_Types
{
    ...
    internal class TitleScreenGUI : ScalingGUI
    {
        public TitleScreenGUI() : base(600,400)
        {
            ...
            AddGuiElement(new GUIElement(Assets.GetTexture2D("banner"), new Rectangle(100, 50, 400, 150)));
            AddGuiElement(new GUIElement(Assets.GetTexture2D("icon"), new Rectangle(250, 250, 100, 100)));
            AddGuiElement(new GUIElement(Assets.GetTexture2D("smiley"), new Rectangle(350, 250, 100, 100)));
